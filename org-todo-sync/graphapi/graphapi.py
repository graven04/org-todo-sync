# Code taken from https://github.com/kiblee/tod0/blob/master/todocli/graphapi/oauth.py
...
def check_keys(keys):
    ...
    if client_id == "replace me" or client_secret == "replace me":
        print(
        ...
        print(
            "Instructions to getting your API client id and secret can be found here:\n{}".format(
                "https://github.com/graven04/org-todo-sync/blob/main/api-key-guide.md"
            )
        )
        exit()
...
if not os.path.isfile(keys_path):
    keys = {"client_id": "replace me", "client_secret": "replace me"}
